...
namespace ContextLab.Migrations
{
    ...
    [Migration("20210416095757_DetailedOrder-Version")]
    partial class DetailedOrderVersion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContextLab.Entities.DetailedOrder", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ContextLab.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("_TableSharingConcurrencyTokenConvention_Version")
                        .IsConcurrencyToken()
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp(6)")
                        .HasColumnName("Version");
            ...
            modelBuilder.Entity("ContextLab.Entities.Rider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContextLab.Entities.DetailedOrder", b =>
                {
                    b.HasOne("ContextLab.Entities.Order", null)
                        .WithOne("DetailedOrder")
                        .HasForeignKey("ContextLab.Entities.DetailedOrder", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
                    ...
                    b.OwnsOne("ContextLab.Entities.ShippingAddress", "ShippingAddress", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("_TableSharingConcurrencyTokenConvention_Version")
                                .IsConcurrencyToken()
                                .ValueGeneratedOnAddOrUpdate()
                                .HasColumnType("timestamp(6)")
                                .HasColumnName("Version");
