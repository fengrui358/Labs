...
public static class DataBasePerformanceLabEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE DataBasePerformanceLabModuleExtensionConfigurator CLASS (in the Domain.Shared project)
